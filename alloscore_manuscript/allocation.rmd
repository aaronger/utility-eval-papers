...
A key observation here is that the Bayes act results from using a \textbf{shared} probability level, $1 - \lambda^{\star}/L$, to determine allocations as the corresponding quantiles of the location-specific forecast distributions $F_i$ which sum to the constraint $K$.
