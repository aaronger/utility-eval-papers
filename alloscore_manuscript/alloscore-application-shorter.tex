...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `palette()`:\\\#\# ! Insufficient values in manual scale. 18 needed but only 17 provided.}}\end{kframe}
\end{knitrout}
