...
COVIDhub-ensemble & 389 & 70 \\ 
  ...
  USC-SI\_kJalpha & 1473 & 155 \\ 
   \hline
\end{tabular}
\caption{Mean weighted interval scores (MWIS) and mean allocation scores (MAS) by model across 13 weeks. These results show the average performance across time for the nine models that submitted forecasts for every week from 2021-11-29 through 2022-02-21, as well
