...
%DIF ADD manuscript.tex             Sun Aug  4 23:47:14 2024
...
scoring rules that directly consider the success of forecasts in supporting specific public health decisions. \DIFdelbegin \DIFdel{As evidence for this
possibility, we }\DIFdelend \DIFaddbegin \DIFadd{The work presented here has applications in many other fields such as economics, where the monetary consequences of using a forecast
...
, sustainability initiatives such as water and energy allocation \mbox{%DIFAUXCMD
\cite{syme1999defining, gebre2021multi, colett2016using}}\hskip0pt%DIFAUXCMD
. We }\DIFaddend have demonstrated how tying forecast evaluation to a specific decision problem (e.g., via the allocation
