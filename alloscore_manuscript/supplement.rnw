...
maker that operates in a resource market and a that $Y$ takes negative values when ``recoveries'' outnumber incidence.  But we do not consider
such scenarios in this work. 
