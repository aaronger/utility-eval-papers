...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in cowplot::plot\_grid(p1, p2, p4, nrow = 3, align = "{}v"{}, rel\_heights = c(1, : object 'p1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in left\_join(alloscore\_data\_summaries, score\_data\_summaries, by = c("{}model"{}, : object 'alloscore\_data\_summaries' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in filter(all\_data, as.Date(reference\_date.x) < as.Date("{}2022-02-01"{})): object 'all\_data' not found}}\end{kframe}
\end{knitrout}
