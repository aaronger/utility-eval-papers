...
\begin{figure}
    \includegraphics[width=\textwidth]{figure/exponential_pred_expected_loss.pdf}
...
\newblock Timing of seasonal influenza epidemics for 25 countries in {A}frica
...
\newblock Temporal changes in {E}bola transmission in {S}ierra {L}eone and
  implications for control requirements: a real-time modelling study.
\newblock \emph{PLOS Currents}, 7, 2015.

\bibitem[Finger et~al.(2019)Finger, Funk, White, Siddiqui, Edmunds, and
  Kucharski]{finger_real-time_2019}
Flavio Finger, Sebastian Funk, Kate White, et~al.
\newblock Real-time analysis of the diphtheria outbreak in forcibly displaced
  {Myanmar} nationals in {Bangladesh}.
\newblock \emph{BMC Medicine}, 17\penalty0 (1):\penalty0 58, March 2019.
\newblock \doi{10.1186/s12916-019-1288-7}.
...
\bibitem[{University of Texas at Austin}(2022)]{utnews2022}
{University of Texas at Austin}.
\newblock {COVID} forecasting method using hospital and cellphone data proves
  it can reliably guide us cities through pandemic threats.
...
\newblock When are predictions useful? {A} new method for evaluating epidemic
  forecasts.
\newblock \emph{medRxiv}, 2023.
\newblock \doi{10.1101/2023.06.29.23292042}.
...
\bibitem[Papastefanopoulos et~al.(2020)Papastefanopoulos, Linardatos, and
  Kotsiantis]{papastefanopoulos2020covid}
Vasilis Papastefanopoulos, Pantelis Linardatos, and Sotiris Kotsiantis.
\newblock {COVID-19}: a comparison of time series methods to forecast
  percentage of active cases per population.
\newblock \emph{Applied Sciences}, 10\penalty0 (11):\penalty0 3880, 2020.

\bibitem[Johansson et~al.(2016)Johansson, Reich, Hota, Brownstein, and
  Santillana]{johansson2016evaluating}
...
\newblock \emph{Scientific reports}, 6\penalty0 (1):\penalty0 33707, 2016.
...
\newblock \emph{Proceedings of the National Academy of Sciences}, 116\penalty0
  (8):\penalty0 3146--3154, February 2019.
...
\newblock An open challenge to advance probabilistic forecasting for dengue
  epidemics.
\newblock \emph{Proceedings of the National Academy of Sciences}, 116\penalty0
  (48):\penalty0 24268--24274, November 2019.
...
\newblock Predictive performance of multi-model ensemble forecasts of
  {COVID}-19 across {E}uropean nations.
\newblock \emph{e{L}ife}, 12:\penalty0 e81916, 2023.
...
\newblock In Michael~P. Clements and David~F. Hendry, editors, \emph{A
  {C}ompanion to {E}conomic {F}orecasting}, chapter~11, pages 241--267.
...
\newblock Decision-making for foot-and-mouth disease control: {O}bjectives
  matter.
\newblock \emph{Epidemics}, 15:\penalty0 10--19, 2016.
\newblock \doi{10.1016/j.epidem.2015.11.002}.
...
\newblock \emph{Analysis of {I}nventory {S}ystems.}
...
\newblock \doi{10.1016/j.jet.2017.08.006}.
...
\newblock Probabilistic energy forecasting: {G}lobal energy forecasting
  competition 2014 and beyond.
\newblock \emph{International Journal of Forecasting}, 32\penalty0
  (3):\penalty0 896--913, 2016.
...
\bibitem[{United States Census Bureau}(2022)]{us_census_nst_est2022}
{United States Census Bureau}.
\newblock {Annual Population Estimates, Estimated Components of Resident
  Population Change, and Rates of the Components of Resident Population Change
  for the United States, States, District of Columbia, and Puerto Rico: April
  1, 2020 to July 1, 2022}.
\newblock US Census Bureau, 2022.
\newblock URL
  \url{https://www2.census.gov/programs-surveys/popest/datasets/2020-2022/state/totals/NST-EST2022-ALLDATA.csv}.
\newblock Accessed: 2024-02-01.
...
\bibitem[Landau(2021)]{landau_2021_targets}
William~Michael Landau.
\newblock The targets r package: a dynamic make-like function-oriented pipeline
  toolkit for reproducibility and high-performance computing.
\newblock \emph{Journal of Open Source Software}, 6\penalty0 (57):\penalty0
  2959, 2021.
\newblock \doi{10.21105/joss.02959}.
...
\bibitem[Ellsberg(1961)]{ellsberg1961risk}
Daniel Ellsberg.
\newblock Risk, ambiguity, and the savage axioms.
\newblock \emph{The Quarterly Journal of Economics}, 75\penalty0 (4):\penalty0
  643--669, 1961.
...
\newblock \doi{10.48550/arXiv.2310.11939}.
